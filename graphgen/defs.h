...
void computeGraph(graph*, graphSDG*, struct graph_shared**, char**);
graph * makeUndirected(graph*, struct graph_shared**, char**);
int64_t graphio_b(graph*, char*, int64_t, struct graph_shared**, char**);
...
double calculateTransitivityGlobal(graph*);
double * calculateClusteringLocal(graph*);
double * calculateTransitivityLocal(graph*);
void agglomerative_partitioning (graph*, double*, int64_t);
int64_t bellman_ford(graph*, int64_t*, int64_t, int64_t*);
int64_t delta_stepping(graph*, double*, int64_t, double*);
int64_t pagerank(graph*, double*, double, double, int64_t);
